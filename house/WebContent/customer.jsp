    ...
    <div class="navigation-row">
	 ...
	 <div class="text-center tm-site-title-wrap">
          <h1 class="tm-site-title">House Rental System</h1>    
                    ...
                    <form class="form-horizontal templatemo-contact-form-1" action="customeract.jsp" method="post" id="adminact" >
                        <br><br>
                        <center>
                        <div class="form-group">
		  		<div class="col-md-12">
		  		<h1 class="margin-bottom-15">Customer Login</h1>
		  		</div>
		  	</div>
                                 ...
                                 <tr>
                                    <td>
                                       ...
                                       <input type="submit" class="btn btn-info pull-right" form="adminact" align="right" value='Submit' />
                                        ...
                                        </table><br><a href="customerreg.jsp"><font size="2">Click Here for Registration</a></br>
</div>
</body>
</html>